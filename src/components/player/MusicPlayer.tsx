...
export function MusicPlayer() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-50">
      {!isCollapsed && (
        <div className="absolute bottom-4 left-1/2 w-full max-w-fit -translate-x-1/2 px-4 sm:bottom-6">
          <div
            className={cn(
            ...
            <div className="hidden md:flex items-center gap-3 w-[200px] lg:w-[280px]">
              ...
              >
                <div className="absolute left-0 right-0 h-1.5 rounded-full bg-muted/80 ring-1 ring-white/[0.05] overflow-hidden">
                  <div
                    className={cn(
                      'h-full bg-gradient-to-r from-[hsl(var(--gradient-from))] via-[hsl(var(--gradient-via))] to-[hsl(var(--gradient-to))]',
                ...
                <div
                  className={cn(
                    'absolute top-1/2 h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/50 bg-primary shadow-sm shadow-primary/30 transition-transform',
                    isSeeking
